...
class Zomato {
  ...
  categories() {
    return this.get("categories").then(data =>
      data.categories.map(o => o.categories)
    );
  }
   ...
   */
  cities(params) {
    return this.get("cities", qs.stringify(params)).then(
   ...
   */
  collections(params) {
    return this.get("collections", qs.stringify(params)).then(data =>
      data.collections.map(o => o.collection)
    );
  }
   ...
   */
  cuisines(params) {
    return this.get("cuisines", qs.stringify(params)).then(data =>
      data.cuisines.map(o => o.cuisine)
    );
  }
  ...
  establishments(params) {
    return this.get("establishments", qs.stringify(params)).then(data =>
      data.establishments.map(o => o.establishment)
    );
  }
   ...
   */
  locations(params) {
    return this.get("locations", qs.stringify(params)).then(
      data => data.location_suggestions
    );
  }
   ...
   */
  dailymenu(params) {
    return this.get("dailymenu", qs.stringify(params)).then(data =>
      data.daily_menus.map(o => o.daily_menu)
    );
  }
   ...
   */
  reviews(params) {
    return this.get("reviews", qs.stringify(params)).then(data => {
   ...
   */
  search(params) {
    return this.get("search", qs.stringify(params)).then(data => {
